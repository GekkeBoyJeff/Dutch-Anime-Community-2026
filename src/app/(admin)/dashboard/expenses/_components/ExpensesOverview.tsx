		...
		<div className="inventory-tab expenses-overview">
			<ul className="con-list">
				<li className="con-line">
					<span className="con-line-main">Totaal besteed (goedgekeurd + uitbetaald)</span>
					<span>{formatEur(grand.committed)}</span>
				</li>
				<li className="con-line">
					<span className="con-line-main">Totaal in behandeling (ingediend)</span>
					<span>{formatEur(grand.pending)}</span>
				</li>
			</ul>
