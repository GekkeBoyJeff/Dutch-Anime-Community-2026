...
import { parsedToChatMessages } from '@/app/(admin)/dashboard/moderation/_components/ticketMapping';
import Button from '@/components/basics/Button';
import StatusBadge from '@/components/basics/StatusBadge';
import Title from '@/components/basics/Title';
import ChatTranscript from '@/components/components/ChatTranscript';
...
const TicketUpload = ({ open, sessionUserId, onClose, onSaved }: Props) => {
	...
	return (
		...
		>
			{!parsed ? (
				<div className="ticket-dropzone" {...getRootProps()} data-active={isDragActive || undefined}>
					<input {...getInputProps()} />
					<p>Sleep een Ticket Tool-transcript (.html) hierheen, of klik om te kiezen.</p>
					<p className="con-note">Eén bestand. Er wordt alleen tekst en bijlage-informatie opgeslagen — geen afbeeldingen.</p>
				</div>
			) : (
