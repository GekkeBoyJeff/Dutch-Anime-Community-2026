...
const InventoryManager = () => {
	...
	const deleteItem = async (id: string) => {
		...
		setRefreshKey((key) => key + 1);
		toast.add({ title: 'Item verwijderd', type: 'success' });
	};
	...
	const deleteEvent = async (id: string) => {
		...
		setRefreshKey((key) => key + 1);
		toast.add({ title: 'Conventie verwijderd', type: 'success' });
	};
	...
	}, [items, users, itemSearch, itemFilter]);
	...
	}, [events, eventSearch, eventFilter, today]);
	...
	return (
		<Container className="inventory">
			...
			<ConfirmDialog
				...
				description={itemToDelete ? `"${itemToDelete.name}" wordt definitief verwijderd.` : undefined}
			...
			<ConfirmDialog
				...
				title="Conventie verwijderen?"
				description={eventToDelete ? `"${eventToDelete.name}" wordt definitief verwijderd.` : undefined}
				confirmLabel="Verwijderen"
				destructive
				onConfirm={() => {
