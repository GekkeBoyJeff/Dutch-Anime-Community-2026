...
export const FaqItem = z
	.object({
		...
		title: z.string().min(1).describe('Visible question text shown as the accordion item trigger'),
		value: z.string().min(1).describe('Answer content rendered inside the expanded accordion item').meta({ editor: 'richtext' }),
