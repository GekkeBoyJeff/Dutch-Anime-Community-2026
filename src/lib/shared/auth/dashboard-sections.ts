...
export const DASHBOARD_SECTIONS: DashboardSection[] = [
	...
	{
		key: 'events',
		title: 'Conventies & events',
		navLabel: 'Conventies & events',
	...
	{
		key: 'my-inventory',
		title: 'Mijn inventory & conventies',
		navLabel: 'Mijn spullen',
...
export const buildTabBarItems = (permissions: ReadonlySet<Permission>): TabBarItem[] => {
	...
	if (permissions.has('inventory.view')) {
		items.push({
			key: 'shifts',
			label: 'Shifts',
			href: '/dashboard/my-inventory#shifts',
			icon: 'calendar',
		});
	}
	return items;
