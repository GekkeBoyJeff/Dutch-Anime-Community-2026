...
// Props for the Swiper component: pointer/keyboard content swiper built on Embla, with slide
...
export const SwiperProps = z
	.object({
		...
		label: z.string().optional().describe('Accessible label for the swiper region; defaults to \'Swiper\''),
