...
import Metric from '@/components/components/Metric/Metric';
import Moment from '@/components/components/Moment/Moment';
import Panel from '@/components/dashboard/components/Panel/Panel';

import Navigation, { type MegaMenuGroup } from './Navigation';
import { NavigationProps } from './Navigation.schema';
		...
		links: [
			{
				key: 'profiel',
				label: 'Profiel',
				description: 'Je account, warnings en badges.',
				href: '/account',
				icon: 'user',
			},
			{
				key: 'my-inventory',
				label: 'Mijn spullen',
				description: 'Je eigen items en wat je moet meenemen.',
			...
			},
			{
				key: 'expenses',
				label: 'Declaraties',
				description: 'Dien kosten in met bon en beoordeel declaraties.',
		...
		links: [
			{
				...
				description: 'Beheer conventies, aanwezigheid en agenda.',
			...
			},
			{
				key: 'inventory',
				label: 'Inventaris',
				description: 'Beheer items en toewijzingen.',
			...
			},
			{
				key: 'team',
				label: 'Team',
				description: 'Standteam en yakuza met shifts en warnings.',
				href: '/dashboard/team',
				icon: 'users',
			},
			{
				key: 'moderation',
				label: 'Moderatie',
				description: 'Profielen, warnings, links en bans.',
		...
		links: [
			{
				key: 'builder',
				label: "Pagina's",
				description: "Bewerk pagina's met de visuele builder.",
				href: '/builder',
				icon: 'edit',
			},
			{
			...
			},
			{
				key: 'surveys',
				label: 'Enquêtes',
				description: 'Maak en beheer enquêtes en polls.',
		...
		links: [
			{
				key: 'access',
				label: 'Toegang',
				description: 'Ken rollen en permissies toe aan gebruikers.',
			...
			},
			{
				key: 'notifications',
				label: 'Meldingen',
				description: 'Stuur meldingen naar leden.',
			...
			},
			{
				key: 'logs',
				label: 'Logs',
				description: 'Activiteit en audit-trail van het beheer.',
				href: '/dashboard/logs',
				icon: 'clock',
			},
		],
