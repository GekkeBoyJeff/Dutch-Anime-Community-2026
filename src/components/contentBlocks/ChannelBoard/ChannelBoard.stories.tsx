...
import { ChannelBoardProps } from './ChannelBoard.schema';
...
export const Default: Story = {
	args: {
		heading: {
			tagline: 'De server',
			title: 'Waar je terechtkomt',
			intro: 'Vijf kanalen waar het meeste gebeurt.',
		},
		items: [
			{
				id: 'ch1',
				name: 'welkom',
				topic: 'hier zeg je hoi',
				rhythm: 'elke dag',
			},
			{
				id: 'ch2',
				name: 'shounen',
				topic: 'one piece, jjk, en alles ernaast',
				rhythm: 'elke dag',
			},
			{
				id: 'ch3',
				name: 'art',
				topic: 'work-in-progress en feedback',
				rhythm: 'een paar keer per week',
			},
			{
				id: 'ch4',
				name: 'weerwolven',
				topic: 'onze eigen async Weerwolven',
				rhythm: 'elke ronde een week',
			},
			{
				id: 'ch5',
				name: 'minecraft',
				topic: 'de server, en wie er bouwt',
				rhythm: 'doorlopend',
			},
		],
	},
