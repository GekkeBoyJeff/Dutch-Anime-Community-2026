...
import GrowingMediaOnScroll from './GrowingMediaOnScroll';
import { GrowingMediaOnScrollProps } from './GrowingMediaOnScroll.schema';
...
export const Video: Story = {
	...
	args: {
		...
		media: {
			type: 'video',
			src: '/media/demo.mp4',
			alt: 'Sfeerimpressie van een meetup',
		},
