...
import ItemCardGrid from '@/components/components/ItemCardGrid/ItemCardGrid';
import type { CardGridItem } from '@/components/components/ItemCardGrid/ItemCardGrid';

import type { CardGridProps as CardGridSchemaProps } from './CardGrid.schema';
