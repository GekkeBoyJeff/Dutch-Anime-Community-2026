...
import { MomentListProps } from './MomentList.schema';
...
export const Default: Story = {
	args: {
		heading: {
			tagline: 'Agenda',
			title: 'Wat er speelt',
			intro: 'Wat we net deden en wat eraan komt.',
		},
		items: [
			{
				id: 'm1',
				date: '2026-06-14',
				title: 'Meetup Utrecht',
				meta: '18 mensen, Neude',
			},
			{
				id: 'm2',
				date: '2026-07-19',
				title: 'Watch party: Summer Wars',
				meta: 'Online, 40 kijkers',
			},
			{
				id: 'm3',
				date: '2026-08-07',
				endDate: '2026-08-09',
				title: 'Abunai!',
				meta: 'Stand in de dealerroom',
			},
			{
				id: 'm4',
				date: '2026-09-20',
				title: 'Herfstmeetup Rotterdam',
				meta: 'Aanmelden via Discord',
			},
			{
				id: 'm5',
				date: '2026-11-14',
