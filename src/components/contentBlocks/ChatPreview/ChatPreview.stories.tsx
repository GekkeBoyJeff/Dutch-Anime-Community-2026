...
import { ChatPreviewProps } from './ChatPreview.schema';
		...
		messages: [
			{
				...
				author: 'Nour',
				time: '19:04',
				value: 'hoi! net binnen, ik kijk vooral shounen',
			},
			{
				id: 'c2',
				author: 'Hugo',
				time: '19:06',
				value: 'hoi Nour, welkom :)',
			},
			{
				id: 'c3',
				author: 'Jesse',
				time: '19:10',
				value: 'oh dan moet je bij #shounen zijn, daar is het altijd druk',
			},
			{
				id: 'c4',
				author: 'Nour',
				time: '19:33',
				value: 'thanks, ga ik doen',
			},
			{
				id: 'c5',
				author: 'Hugo',
				time: '19:40',
				value: 'en als je iets zoekt, roep maar',
			},
		],
	...
	args: {
		...
		messages: [
			...
			},
			{
				...
				author: 'Sam',
				time: '21:12',
				value: 'iemand hier die Frieren volgt?',
			},
			{
				id: 'd3',
				author: 'Yuki',
				time: '21:19',
				value: 'ik! net bij aflevering 12',
			},
		],
