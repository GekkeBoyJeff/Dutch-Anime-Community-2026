...
import { CountUpProps } from '@/components/basics/CountUp/CountUp.schema';
...
export const StatBandBlock = StatBandProps.extend({ type: z.literal('statBand'), id: Id.optional() }).meta({ category: 'other' });
