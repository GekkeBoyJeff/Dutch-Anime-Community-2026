...
import { Colorset, Id } from '@/lib/site/content/shared';
...
export const ReviewsBlock = ReviewsProps.extend({ type: z.literal('reviews'), id: Id.optional() }).meta({ category: 'marketing' });
