...
import { Colorset, Heading, IconName, Id } from '@/lib/site/content/shared';
...
export const IntroGridBlock = IntroGridProps.extend({ type: z.literal('introGrid'), id: Id.optional() }).meta({ category: 'grids' });
