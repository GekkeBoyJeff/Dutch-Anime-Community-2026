...
import { Colorset, Id, Media } from '@/lib/site/content/shared';
...
export const SpotlightQuoteBlock = SpotlightQuoteProps.extend({ type: z.literal('spotlightQuote'), id: Id.optional() }).meta({ category: 'other' });
