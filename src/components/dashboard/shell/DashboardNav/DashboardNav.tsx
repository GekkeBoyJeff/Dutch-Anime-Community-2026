...
import Shortcut from '@/components/basics/Shortcut/Shortcut';
import Skeleton from '@/components/basics/Skeleton/Skeleton';
import BottomTabBar from '@/components/dashboard/structures/BottomTabBar/BottomTabBar';
import CommandPalette, { type PaletteResult } from '@/components/dashboard/structures/CommandPalette/CommandPalette';
import Navigation, { type MegaMenuUser } from '@/components/structures/Navigation/Navigation';
...
import '@/components/structures/MegaMenu/MegaMenu.scss';
