...
export interface PersonValue {
	/** Linked user id, or `null` for free-text mode */
	userId: string | null;
	/** Free-text label; only meaningful when `userId` is `null` */
	label: string | null;
}
...
export interface PersonPickerProps {
	...
	/** Prefix for both field labels; defaults to `'Persoon'` */
	labelText?: string;
}
...
const PersonPicker = ({ users, value, onChange, labelText = 'Persoon' }: PersonPickerProps) => (
	<>
