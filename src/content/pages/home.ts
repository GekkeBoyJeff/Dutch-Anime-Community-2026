	...
	blocks: [
		{
			...
			media: {
				...
				alt: 'Leden van DAC op een spelletjesmiddag',
			},
			actions: [
				{
					value: 'Word lid',
			...
			items: [
				{
					...
					media: {
						type: 'image',
						src: '/media/dcc-2024.png',
						alt: 'DAC-leden samen bij de stand op Dutch Comic Con',
					},
					tagline: 'Erbij horen',
				...
				},
				{
					...
					media: {
						type: 'image',
						src: '/media/dcc-2023-highlights.png',
						alt: 'Cosplay en creatief werk op een con',
					},
					tagline: 'Laten zien',
		...
		},
		{
			...
			slides: [
				{
					image: '/media/dac-meetup.png',
					alt: 'Grote groepsfoto op een DAC-meetup',
					title: 'Meetup met de crew',
					description: 'De mensen achter de usernames, in het echt.',
				},
				{
					image: '/media/dcc-2024.png',
					alt: 'DAC-stand op Dutch Comic Con 2024',
					title: 'Dutch Comic Con 2024',
					description: 'Onze drukste stand tot nu toe.',
				},
				{
					image: '/media/spelletjesmiddag.jpg',
					alt: 'Bordspellen op een DAC-spelletjesmiddag',
					title: 'Spelletjesmiddag',
					description: 'Bordspellen en veel gelach, in Den Haag.',
				},
				{
					image: '/media/hmia-2024.png',
					alt: 'DAC-groepsfoto op Heroes Made in Asia',
					title: 'Heroes Made in Asia',
					description: 'Twee dagen cosplay en groepsfoto\'s.',
				},
				{
					image: '/media/dcc-2023-highlights.png',
					alt: 'Hoogtepunten van DAC op Dutch Comic Con 2023',
					title: 'Dutch Comic Con 2023',
					description: 'Waar de stand groot werd.',
				},
			],
		},
		{
			...
			items: [
				{
					...
					title: 'Weerwolven van Wakkerdam',
					value: 'Eén speeldag duurt een echte dag. Je stemt wanneer het jou uitkomt, niet om acht uur \'s avonds.',
				},
				{
					id: 'b-dag',
					span: 'feature',
					...
					media: {
						type: 'image',
						src: '/media/amelia.png',
						alt: 'Amelia, de mascotte van DAC',
					},
					tagline: 'Buiten anime',
					title: 'Gewoon je dag delen',
					value: 'School, werk, en of je huisgenoot te ver ging met de afwas. Niet alleen anime dus.',
				},
				{
					id: 'b-watch',
					span: 'standard',
					tagline: 'Samen kijken',
					title: 'Watch parties',
					value: 'Samen kijken. Meepraten hoeft niet.',
				},
				{
					id: 'b-game',
					span: 'standard',
					tagline: 'Gamen',
					title: 'Game nights',
					value: 'Onze eigen server draait al jaren.',
				},
				{
					id: 'b-art',
					span: 'standard',
					surface: 'muted',
					tagline: 'Creatief',
					title: 'Art en verhalen',
					value: 'Ook werk dat nog niet af is.',
				},
				{
					id: 'b-cosplay',
					span: 'standard',
					tagline: 'Cosplay',
					title: 'Cosplay',
					value: 'Naaitips vragen, groepscosplays plannen.',
				},
				{
					id: 'b-media',
					span: 'standard',
					surface: 'muted',
					tagline: 'Luisteren',
					title: 'Muziek en films',
					value: 'Playlists delen, filmavonden plannen.',
				},
				{
					id: 'b-cultuur',
					span: 'standard',
					tagline: 'Cultuur',
					title: 'Japan en Korea',
					value: 'Waarom ontbijt daar soep bevat.',
				},
			],
		},
		{
