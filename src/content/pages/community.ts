			...
			items: [
				{
					...
					media: {
						...
						alt: 'Cosplay en anime-activiteiten op een con',
					},
					tagline: 'De kern',
					title: 'Anime en manga',
					value: 'Seizoenspremières, oude parels, en wat jij nu kijkt. Iemand heeft het altijd al gezien.',
				},
				{
					id: 'p-dag',
					span: 'wide',
					...
					value: 'School, werk, en of je huisgenoot te ver ging met de afwas. Ook dat hoort erbij.',
				},
				{
					id: 'p-gamen',
					span: 'standard',
					tagline: 'Gamen',
					title: 'Games en Minecraft',
					value: 'Onze eigen server. Cozy bouwen of fanatiek potjes.',
				},
				{
					id: 'p-cosplay',
					span: 'standard',
					tagline: 'Cosplay',
					title: 'Cosplay',
					value: 'Wie naait er mee aan een groepscosplay voor maart?',
				},
				{
					id: 'p-art',
					span: 'standard',
					...
					value: 'Tekeningen, edits, fanfiction. Feedback is eerlijk en aardig.',
				},
				{
					id: 'p-muziek',
					span: 'standard',
					...
					value: 'Playlists die je nergens anders gedeeld krijgt.',
				},
				{
					id: 'p-cultuur',
					span: 'standard',
					...
					value: 'Wie er geweest is, vertelt hoe het echt was.',
				},
				{
					id: 'p-watch',
					span: 'standard',
			...
			items: [
				{
					...
					name: 'Hugo',
					role: 'Oprichter',
					value: 'Begon de server in 2019 en host Weerwolven van Wakkerdam.',
				},
				{
					id: 't-ademen',
					name: 'Ademen',
					role: 'Staff en social',
					value: 'Houdt de boel netjes en runt Instagram, TikTok en X.',
				},
				{
					id: 't-event',
					name: 'Het eventteam',
					role: 'Online events',
					value: 'Regelt wat er elke week online gebeurt.',
				},
				{
					id: 't-stand',
					name: 'Het standteam',
					role: 'Op de cons',
					value: 'Zet de stand neer op de cons en draait daar de anime-quiz.',
				},
			],
		},
		{
