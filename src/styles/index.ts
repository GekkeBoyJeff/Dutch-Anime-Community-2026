...
import '@/styles/components/dashboard/components/AvatarRow.scss';
import '@/styles/components/dashboard/components/BadgeGallery.scss';
import '@/styles/components/dashboard/components/BarBreakdown.scss';
...
import '@/styles/components/dashboard/components/DetailRow.scss';
...
import '@/styles/components/dashboard/components/LeadLine.scss';
import '@/styles/components/dashboard/components/LineList.scss';
...
import '@/styles/components/dashboard/components/StatTile.scss';
...
import '@/styles/components/dashboard/structures/AsyncCard.scss';
