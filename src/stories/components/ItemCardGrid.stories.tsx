...
import { ItemCardGridProps } from '@/lib/site/content/schema/components/itemCardGrid';
...
const articleItems = [
	{
		...
		text: 'A tour of the tokens, primitives and blocks.',
		media: demoImage,
		tag: 'Guides',
		category: 'guides',
	...
	},
	{
		...
		text: 'How light and dark cascade without a colour prop.',
		media: demoImage,
		tag: 'Theming',
		category: 'theming',
	...
	},
	{
		...
		text: 'Whole-card links, focus order and reduced motion.',
		media: demoImage,
		tag: 'A11y',
		category: 'a11y',
	...
	},
	{
		...
		text: 'One registry, one schema, one page contract.',
		media: demoImage,
		tag: 'Guides',
		category: 'guides',
...
const meta: Meta<typeof ItemCardGrid> = {
	...
	parameters: {
		...
		jsonSchema: { schema: ItemCardGridProps },
	},
};
...
export const Default: Story = {
	args: {
		...
		heading: {
			title: 'From the blog',
			tagline: 'Latest',
			intro: 'Filter, search and sort the writing.',
		},
		items: articleItems,
		categories: [
			{
		...
		items: [
			{
				id: 'l1',
				title: 'Documentation',
				text: 'Guides, references and recipes.',
				href: '#',
			},
			{
				id: 'l2',
