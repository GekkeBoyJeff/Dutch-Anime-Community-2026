...
import { ReviewsProps } from '@/lib/site/content/schema/blocks/reviews';
...
export const Default: Story = {
	args: {
		...
		items: [
			{ id: 'r1', author: 'Sara', rating: 5, value: 'My new site was live in an afternoon.' },
			{ id: 'r2', author: 'Daan', rating: 5, value: 'The structure is clear and easy to extend.' },
			{ id: 'r3', author: 'Noor', rating: 4, value: 'A solid base with well-designed components.' },
		],
	},
};
