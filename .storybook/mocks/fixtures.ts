...
export const FIXTURES: Record<string, unknown[]> = {
	events: [
		{
			...
			starts_on: day(21),
			ends_on: day(23),
			signups_open_at: at(-10, 9),
			signups_close_at: at(14, 23),
			notes: 'Standplek B12, opbouw vrijdagochtend.',
			archived_at: null,
			budget_eur: 2500,
		},
		{
	...
	expenses: [
		{
			...
			user_id: USER_ID,
			event_id: 'evt-1',
			description: 'Treinkaartje opbouwdag',
			amount_eur: 24.4,
			incurred_on: day(-6),
			status: 'submitted',
			category: 'travel',
			archived_at: null,
			review_note: null,
			receipt_path: 'usr-0001/exp-1/bon.jpg',
			iban: 'NL91 ABNA 0417 1643 00',
			account_holder: 'J. de Vries',
		},
		{
			id: 'exp-2',
			user_id: USER_ID,
			...
			archived_at: null,
			review_note: null,
			receipt_path: 'usr-0001/exp-2/bon.pdf',
			iban: 'NL91 ABNA 0417 1643 00',
			account_holder: 'J. de Vries',
		},
		{
			...
			user_id: 'usr-0002',
			event_id: 'evt-3',
			description: 'Posters laten drukken',
			amount_eur: 89.0,
			incurred_on: day(-30),
			status: 'rejected',
			category: 'stand',
			archived_at: null,
			review_note: 'Geen bon bijgevoegd.',
			receipt_path: 'usr-0002/exp-3/bon.jpg',
			iban: 'NL02 RABO 0123 4567 89',
			account_holder: 'S. Bakker',
		},
		{
			id: 'exp-4',
			user_id: 'usr-0002',
			...
			archived_at: null,
			review_note: null,
			receipt_path: 'usr-0002/exp-4/bon.jpg',
			iban: 'NL02 RABO 0123 4567 89',
			account_holder: null,
		},
		{
			...
			user_id: USER_ID,
			event_id: null,
			description: 'Lunch onderweg',
			amount_eur: 18.75,
			incurred_on: day(-24),
			status: 'rejected',
			category: 'food',
			archived_at: null,
			review_note: 'Eten onderweg valt niet onder de vergoeding.',
			receipt_path: 'usr-0001/exp-5/bon.jpg',
			iban: 'NL91 ABNA 0417 1643 00',
			account_holder: 'J. de Vries',
		},
	],
	profiles: [
		...
		{
			id: USER_ID,
			username: 'gekkeboyjeff',
			global_name: 'Jeffrey',
			guild_nick: 'Jeffrey (DAC)',
			discord_id: '123456789012345678',
			guild_roles: ['Yakuza', 'Standteam'],
			guild_joined_at: at(-900, 12),
			avatar_url: null,
			public_name: 'Jeffrey',
			age: 29,
			instagram: 'gekkeboyjeff',
			about: 'Standteam sinds 2023, meestal bij de kassa te vinden.',
			photo_path: null,
			terms_accepted_at: at(-200, 12),
		...
		},
		{
			...
			global_name: 'Sanne',
			guild_nick: 'Sanne (standteam)',
			discord_id: '234567890123456789',
			guild_roles: ['Standteam'],
			guild_joined_at: at(-300, 9),
			avatar_url: null,
		},
...
export const STORAGE_FIXTURES: Record<string, unknown[]> = {
	media: [
		{
			id: 'md-1',
			name: 'hero-abunai-2026.jpg',
			created_at: at(-2, 11),
			metadata: { mimetype: 'image/jpeg', size: 284_113 },
		},
		{
			id: 'md-2',
			name: 'stand-opbouw.png',
			created_at: at(-9, 16),
			metadata: { mimetype: 'image/png', size: 512_004 },
		},
	],
};
